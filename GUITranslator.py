...
GUI = Tk() #สร้างหน้าต่างหลัง
GUI.geometry('500x300') #กว้าง x สูง
GUI.title('โปรแกรมแปลภาษา by พี่เอื้อ')
# -----config-----
FONT = ('Angsana New' ,15)
# -----Label-----
...
B1.pack(ipadx=15,ipady=10) # show ปุ่มขึ้นมาวางจากบนลงล่าง
# -----Label-----
...
GUI.mainloop() #ทำให้โปรแกรมรันได้ตลอดเวาจนกว่าจะปิด (บรรทัดสุดท้าย)
